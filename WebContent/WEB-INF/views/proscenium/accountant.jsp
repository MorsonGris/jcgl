        ...
        <div class="container">
            <div class="row" style="margin-top: 20px;text-align: center">
                <div class="col-xs-6 column">
                    <p>
                        <img alt="140x140" src="images/ewm.png" style="width: 90%;margin-bottom: 10px;" />
                    </p>
                    <h4><img src="images/phone5.png" style="width: 30%"><span>800-8580990</span></h4>
                ...
                <div class="col-xs-6 column">
                    <p>
                        <img alt="140x140" src="images/ewm2.png" style="width: 90%;margin-bottom: 20px;" />
                    </p>
                    <h4>友情链接</h4>
