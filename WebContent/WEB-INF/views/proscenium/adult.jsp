    ...
    <div class="container"> 
	   <div class="row clearfix"> 
	    <div class="col-md-12"> 
	     ...
	     <div class="piece image-con" style="padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px;" data-idx="11"> 
	      <div class="image-box"> 
	       <a target="_blank" class="image-link" href="javascript:void(0);"> <img class="image-item" src="${path }/static/proscenium/images/119100041507333ed9fd.png" /> </a> 
	       <span class="image-text"></span> 
	      </div> 
	     </div> 
