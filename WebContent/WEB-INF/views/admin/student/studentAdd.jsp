        ...
        <form id="studentAddForm" method="post">
            <table class="grid">
                ...
                <tr>
	                <td>报考院校</td>
                    <td>
                    	<input name="academyId" type="text" placeholder="请输入报考院校" class="easyui-validatebox" data-options="required:true,novalidate:true" value="">
                    </td> 
                	<td>报考专业</td>
                	<td>
                		<input type="text" id="sContent" name="sContent" class="easyui-validatebox" data-options="required:true,novalidate:true" value=""> 
                	</td>
                </tr>
                <tr>
                	<td>报考层次</td>
