...
<script type="text/javascript">
  ...
  var disparkaddDataGrid;
  function selectUser() {
	  disparkaddDataGrid = $('#disparkaddDataGrid').datagrid({
  ...
  $("#addbtn").click(function() {
	  var row = $('#disparkaddDataGrid').datagrid('getSelected');
	  $("#userId").val(row.id);
	  $("#name").val(row.name);
	  $('#win').window('close');
	});
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="disparkAddForm" method="post">
            <table class="grid">
                <tr>
                    <td>学生姓名</td>
...
<div id="win" class="easyui-window" title="用户表" closed="true"  style="width:440px;height:300px;">
  	<div style="width:430px;height:220px;">
  		<table id="disparkaddDataGrid" data-options="fit:true,border:false"></table>
  	</div>
